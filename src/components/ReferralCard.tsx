...
import { Copy, Check, Share2, Link2, Users } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
        ...
        <div>
          <div style={{ fontWeight: 700, fontSize: 16 }}>Your referral link</div>
          <div style={{ fontSize: 12.5, color: "var(--faint)" }}>
            Invite friends and earn bonus points on every activation
          </div>
        </div>
      </div>
      ...
      <div style={{ display: "flex", gap: 10, alignItems: "center", marginBottom: 14 }}>
        ...
        >
          ...
          <span
            className="mono"
            style={{ fontSize: 14, fontWeight: 800, letterSpacing: "0.1em", color: "var(--gold-bright)" }}
          >
            {code}
          </span>
        </div>
        ...
        <button
          ...
          style={{ padding: "0 18px", height: 44, flexShrink: 0, borderRadius: 10, fontSize: 13 }}
        >
          {copied ? (
            <>
              <Check size={14} />
      ...
      <p style={{ color: "var(--muted)", fontSize: 13, margin: 0 }}>
        Share your link · Every activation earns you a referral bonus on the current tier&apos;s schedule.
      </p>
    </div>
  );
}
