...
import { RoiPlanExplorer } from "@/components/RoiPlanExplorer";
...
export default async function Landing() {
  const [{ slabRows, ticker, stats, settings: cfg, royaltyTiers, roiSettings, roiLevelTiers }, session] = await Promise.all([
  ...
  return (
    <main style={{ paddingBottom: 0 }}>
      ...
      <section className="container" style={{ padding: "72px 24px 20px", textAlign: "center" }}>
        ...
        {roiSettings && (
          <div style={{ marginTop: 48 }}>
            <RoiPlanExplorer settings={roiSettings} tiers={roiLevelTiers} />
          </div>
        )}
      </section>
